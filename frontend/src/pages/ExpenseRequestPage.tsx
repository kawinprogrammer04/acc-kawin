...
export function ExpenseRequestWizardPage() {
  ...
  const saveItems = async (advance: boolean) => {
    ...
    if (wantsWithholding && (!tax.taxpayer_type || !tax.taxpayer_id.trim() || !tax.taxpayer_address.trim() || !tax.service_description.trim())) { setError("กรุณากรอกข้อมูลผู้เสียภาษีและรายละเอียดบริการหรือเงินได้ให้ครบ"); return; }
